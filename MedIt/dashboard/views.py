...
def dashboard_admin_view(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            try:
                ...
                messages.warning(request, f'Запись на {date} для {clinic.name} уже существует.')
                if 'overwrite' in request.POST:
                    existing_revenue.revenue = form.cleaned_data['revenue']
    ...
    return render(request, 'dashboard/dashboard_admin.html', {'form': form})
